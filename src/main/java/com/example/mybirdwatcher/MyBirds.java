...
public class MyBirds extends AppCompatActivity {
    ...
    DatabaseHelper myDB;
    ArrayList<String> bird_id;
    ArrayList<String> bird_name;
    ArrayList<String> bird_location;
    ArrayList<String> bird_date;
    ArrayList<byte[]> bird_image;
